...
<!--        <td><a href="#">{!! FA::fixedWidth('trash-o') !!}Delete</a></td>-->
        <td>
<!--            <button class="delete-modal" data-id="{{$page->id}}" data-title="{{$page->title}}"  >
                <span>{!! FA::fixedWidth('trash-o') !!}Delete</span>
            </button>-->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer">
              <button type="button" value="{!!$page->id!!}" id="buttonFooter" class="btn actionBtn" data-dismiss="modal">
